...
export const SIGN_IN = "Nocalhost.signin";
export const SIGN_OUT = "Nocalhost.signout";

export const INSTALL_APP = "Nocalhost.installApp";
export const INSTALL_APP_SOURCE = "Nocalhost.installAppSource";
...
export const SWITCH_ASSOCIATE = "Nocalhost.switchAssociate";
